...
How does the media play into this? And how does this translate in to voting behaviour?


*Frame Competition Hypothesis: The more similar an issue's framing to a given parties' issue framing, the better that parties' electoral prospect.*

Different from Meguid salience X position model: it is the media, not the party that moves!!
