...
Now, using these party-framing vectors, *I can assess the similarity of each news article towards each party's migration framing, simply by taking the cosine distance to the party's vector*. Figure \@ref(fig:vectors) gives an example: the article vector (representing the distribution of different topics within the article) is clearly closer to the vector of party a (representing the distribution of topics in party a's communication), compared to party b.
